...
DEPENDENCIES=(
    ...
    [psycopg-3.2.10]=https://github.com/psycopg/psycopg/archive/refs/tags/3.2.10.zip
    ...
    [psycopg-3.3.2]=https://github.com/psycopg/psycopg/archive/refs/tags/3.3.2.zip
)
